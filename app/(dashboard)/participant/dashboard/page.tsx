...
export default async function ParticipantDashboard() {
  ...
  // Statistiques
  const totalCompetitions = participations?.length ?? 0;
  const acceptedCompetitions =
    participations?.filter((p) => p.status === "ACCEPTED").length ?? 0;
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          <CardHeader>
            ...
            <CardDescription>
              Vos {participations?.slice(0, 5).length} dernières compétitions
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-4">
                {participations.slice(0, 5).map((participation) => (
                  ...
                  >
                    ...
                    <Link
                      href={`/participant/competitions/${participation.competition.id}`}
                    >
